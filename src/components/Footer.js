                  ...
                  <li>
                    <div className="unit flex-column flex-sm-row align-items-center">
                      ...
                      <div className="unit-body">
                        <a href="#">
                          19/2 Near Aashiyana House, Sector - 8
                          <br />
                          CDA, Cuttack  India
                        </a>
                      </div>
            ...
            <div className="row row-10 row-sm-30 align-items-center justify-content-sm-between">
              ...
              <div className="col-sm-auto col-lg-4">
                <ul className="list-inline list-social-4 list-inline-xs">
                  <li>
                    <a className="icon mdi mdi-facebook icon-xxs" href="https://www.facebook.com/satyanayak.nirmal.3" />
                  </li>
                  <li>
                    <a className="icon mdi mdi-twitter icon-xxs" href="https://twitter.com/iAmsatyaPN" />
                  </li>
                  <li>
                    <a className="icon mdi mdi-instagram icon-xxs" href="https://www.instagram.com/itz._.me._.satya/" />
                  </li>
                </ul>
              </div>
              <div className="col-lg-4 text-lg-right">
                <p className="rights">
                  ...
                  <span> </span>
                  <span><a href="https://satyaprakashnayak.netlify.app/">Developed by Satya</a></span>
